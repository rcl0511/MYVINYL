...
import { getLPById, MOCK_COMMENTS } from "@/lib/mock-data";
import type { LPSide } from "@/lib/types";
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex">
      ...
      <div className="w-[440px] shrink-0 bg-lp-bg flex flex-col items-center px-10 py-10">
        ...
        >
          <div className="w-36 h-36 rounded-full border-4 border-white/20 relative flex items-center justify-center">
            <div
          ...
          {/* Genre badge */}
          <span className="absolute top-4 right-4 px-3 py-1 bg-black/40 text-white text-xs font-medium rounded-full backdrop-blur-sm">
            {lp.genre}
          </span>
        </div>
        ...
        <div className="max-w-3xl px-12 py-10">
          ...
          <div className="mt-8">
            ...
            <div className="flex gap-3 mb-8">
              <div className="w-9 h-9 rounded-full bg-lp-placeholder shrink-0" />
                ...
                <div key={comment.id} className="flex gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mt-2">
                      <button className="flex items-center gap-1 text-xs text-lp-tertiary hover:text-lp-danger transition-colors">
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                          <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
                        </svg>
                        {comment.likeCount}
                      </button>
                      <button className="text-xs text-lp-tertiary hover:text-lp-accent transition-colors">
                        답글
                      </button>
                    </div>
                  </div>
